...
describe('userReducer reducer', () => {
  ...
  it('should handle UPDATE_TOKEN_REQUEST', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, updateTokenRequest: true
    })
  })

  it('should handle UPDATE_TOKEN_SUCCESS', () => {
    expect(userReducer(initialUserState, {
      type: UPDATE_TOKEN_SUCCESS, token: {token}
    })).toEqual({
  ...
  it('should handle UPDATE_TOKEN_FAILED', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, updateTokenFailed: true
    })
  })
  ...
  it('should handle AUTHORIZE_REQUEST', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState,  authRequest: true
    })
  })

  it('should handle AUTHORIZE_SUCCESS', () => {
    expect(userReducer(initialUserState, {
      type: AUTHORIZE_SUCCESS, user: {user}
    })).toEqual({
      ...initialUserState, data: {user},
    })
  })
  ...
  it('should handle AUTHORIZE_FAILED', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, authFailed: true
    })
  })
  ...
  it('should handle GET_USER_REQUEST', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, currentUserRequest: true
    })
  })

  it('should handle GET_USER_SUCCESS', () => {
    expect(userReducer(initialUserState, {
      type: GET_USER_SUCCESS, user: {currentUser}
    })).toEqual({
      ...initialUserState, user: {currentUser},
    })
  })
  ...
  it('should handle GET_USER_FAILED', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, currentUserFailed: true
    })
  })
  ...
  it('should handle SET_USER_REQUEST', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, userRequest: true
    })
  })

  it('should handle SET_USER_SUCCESS', () => {
    expect(userReducer(initialUserState, {
      type: SET_USER_SUCCESS, user: {currentUser}
    })).toEqual({
      ...initialUserState, data: {currentUser},
    })
  })
  ...
  it('should handle SET_USER_FAILED', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, userFailed: true
    })
  })
  ...
  it('should handle UPDATE_USER_SUCCESS', () => {
    expect(userReducer(initialUserState, {
      type: UPDATE_USER_SUCCESS, user: {currentUser}
    })).toEqual({
      ...initialUserState, user: {currentUser},
    })
  })
  ...
  it('should handle DELETE_USER_REQUEST', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, deleteUserRequest: true
    })
  })
  ...
  it('should handle DELETE_USER_FAILED', () => {
    expect(userReducer(initialUserState, {
      ...
      ...initialUserState, deleteUserFailed: true
    })
  })
