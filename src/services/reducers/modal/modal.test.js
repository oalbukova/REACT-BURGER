...
const initialModalState = {
  isOrderModalVisible: false, isErrModalVisible: false, error: "",
};
...
describe('modal reducer', () => {
  ...
  it('should handle OPEN_ERR_MODAL', () => {
    expect(modalReducer(initialModalState, {
      ...
      ...initialModalState, isErrModalVisible: true,
    })
  })

  it('should handle CLOSE_ERR_MODAL', () => {
    expect(modalReducer({
      isOrderModalVisible: false, error: "", isErrModalVisible: true,
    }, {
      type: CLOSE_ERR_MODAL,
    })).toEqual({
      ...initialModalState, isErrModalVisible: false,
    })
  })
  ...
  it('should handle OPEN_ORDER_MODAL', () => {
    expect(modalReducer(initialModalState, {
      ...
      ...initialModalState, isOrderModalVisible: true,
    })
  })

  it('should handle CLOSE_ORDER_MODAL', () => {
    expect(modalReducer({
      isOrderModalVisible: true, isErrModalVisible: false, error: "",
    }, {
      type: CLOSE_ORDER_MODAL,
    })).toEqual({
      ...initialModalState, isOrderModalVisible: false,
    })
  })
